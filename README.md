...
## Algorithm
1. Import the required libraries such as pandas, numpy, and SGDClassifier from sklearn.

2. Load the Iris flower dataset and separate the input features and target species labels.

3. Split the dataset into training data and testing data using train_test_split().

4. Apply feature scaling using StandardScaler to normalize the input values.

5. Create and train the SGD Classifier model using the training dataset.

6. Predict the Iris flower species using the test dataset and evaluate the model accuracy.
...
## Output:
<img width="1305" height="422" alt="image" src="https://github.com/user-attachments/assets/b601bf0c-d12d-4c2f-b8b8-78dc019392b4" />


## Result:
Thus, the SGD Classifier model was successfully implemented to predict the species type of the Iris flower with good accuracy.
